...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($siteName === '' || $siteUrl === '' || $uploadDir === '' || $logsDir === '') {
        ...
        // Persist to config/local_settings.php (env overrides)
        $content = "<?php\n".
                   "// Generated by admin/settings on ".date('c')."\n".
                   "putenv('SITE_NAME='.var_export(".$_POST['SITE_NAME'].", true));\n";
...
if (!isset(\\$_ENV['{$k}'])) { \\$_ENV['{$k}'] = {$escaped}; }
if (!isset(\\$_SERVER['{$k}'])) { \\$_SERVER['{$k}'] = {$escaped}; }
";
        }
        $php .= "";
